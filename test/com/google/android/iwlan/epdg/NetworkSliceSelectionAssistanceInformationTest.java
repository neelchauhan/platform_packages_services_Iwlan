...
public class NetworkSliceSelectionAssistanceInformationTest {
    ...
    public void testNullNssai() throws Exception {
        SliceInfo si = NetworkSliceSelectionAssistanceInformation.getSliceInfo(null);
        assertNull(si);
    }
    ...
    public void testNssaiWithSST() throws Exception {
        ...
        assertEquals(si.getMappedHplmnSliceServiceType(), SliceInfo.SLICE_SERVICE_TYPE_NONE);
        assertEquals(si.getSliceDifferentiator(), SliceInfo.SLICE_DIFFERENTIATOR_NO_SLICE);
        assertEquals(
                si.getMappedHplmnSliceDifferentiator(), SliceInfo.SLICE_DIFFERENTIATOR_NO_SLICE);
    }
