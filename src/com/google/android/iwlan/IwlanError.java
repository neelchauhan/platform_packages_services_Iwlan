...
public class IwlanError {
    ...
    /**
     * Sets the IwlanError based on the Exception:
     * 1. IkeException is base the class for all IKE
     *    exception ErrorType: IKE_GENERIC_EXCEPTION.
     * 2. IkeProtocolException is for specific protocol errors
     *    (like IKE notify error codes) ErrorType: IKE_PROTOCOL_EXCEPTION
     * 3. IkeInternalException is just a wrapper for various exeptions
     *    that IKE lib may encounter
     *    ErrorType: IKE_INTERNAL_IO_EXCEPTION if the Exception is instance of IOException
     *    ErrorType: IKE_GENERIC_EXCEPTION for all the other.
     */
    public IwlanError(@NonNull Exception exception) {
        // resolve into specific types if posible
